...
try:
    ...
    import json
    encrypted = True
# from bittrex_db_client import BittrexMongoClient
...
class Bittrex(object):
    ...
    def __init__(self, api_key, api_secret, dispatch=using_requests):
        ...
        # self.db = BittrexMongoClient(db_name='bittrex_data')
    ...
    def buy_limit(self, market, quantity, rate):
        ...
        :rtype : dict
        """
        data = {'market': market, 'quantity': quantity, 'rate': rate}
        response =  self.api_query('buylimit', data)
        # print response
        return response
    ...
    def get_order(self, uuid):
        ...
        :rtype : dict
        """
        response = self.api_query('getorder', {'uuid': uuid})
        return response
